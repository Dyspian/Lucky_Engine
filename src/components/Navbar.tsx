...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-white/5 bg-background/80 backdrop-blur-xl shadow-lg"> {/* Added shadow-lg */}
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <Logo imgClassName="h-10" imageUrl={logoUrl} alt="Lucky Engine Logo" ariaLabel="Lucky Engine Logo" />
        {/* Removed the redundant second logo */}
      </div>
    </nav>
  );
};
