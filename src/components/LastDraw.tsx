...
const LastDraw = ({ draw }: LastDrawProps) => {
  ...
  return (
    <Card className="border-none bg-indigo-900 text-white shadow-2xl overflow-hidden">
      <CardHeader className="pb-2">
        <CardTitle className="text-sm font-medium flex items-center gap-2 text-indigo-200 uppercase tracking-widest">
      ...
      <CardContent>
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-indigo-300 text-sm">Officiële resultaten van de laatste trekking</p>
          </div>
          <div className="flex flex-wrap gap-2 items-center">
            ...
            <div className="w-px h-8 bg-indigo-700 mx-2 hidden sm:block" />
            <div className="flex gap-2">
              {draw.stars.map((s, i) => (
